...
export class BedrockKbConstruct extends Construct {
  ...
  public readonly description: string =
    "Agent in charge of providing response regarding the \
  ...
  constructor(scope: Construct, id: string) {
    ...
    interface CustomS3DataSourceProps extends bedrock.S3DataSourceProps {
      maxTokens?: number;
    }
    ...
    const menuDataSource = new bedrock.S3DataSource(this, "DocumentsDataSource", {
      ...
      maxTokens: 500, // Optional custom property
      overlapPercentage: 20,
    } as CustomS3DataSourceProps);
    ...
    syncDataSourceLambdaRole.addManagedPolicy(iam.ManagedPolicy.fromManagedPolicyArn(this, "syncDataSourceLambdaRoleAWSLambdaBasicExecutionRole", "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"));
